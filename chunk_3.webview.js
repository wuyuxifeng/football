...
Z([3,'top'])
Z([[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[1,'padding-top:'],[[2,'?:'],[[7],[3,'isMP']],[[2,'+'],[[7],[3,'titleTop']],[1,'px']],[1,'100rpx']]],[1,';']],[[2,'+'],[[2,'+'],[1,'height:'],[[2,'?:'],[[7],[3,'isMP']],[[2,'+'],[[7],[3,'titleHeight']],[1,'px']],[1,'64rpx']]],[1,';']]],[[2,'+'],[[2,'+'],[1,'background:'],[[7],[3,'titleBarColor']]],[1,';']]])
Z([3,'__e'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'back']]]]]]]]])
Z([[6],[[7],[3,'$root']],[3,'m0']])
Z([3,'width:60rpx;height:60rpx;flex-shrink:0;'])
Z([3,'title'])
Z([[2,'+'],[[2,'+'],[1,'color:'],[[7],[3,'titleTextColor']]],[1,';']])
Z([a,[[7],[3,'title']]])
...
var lWBB=_mz(z,'view',['class',0,'style',1],[],e,s,gg)
var aXBB=_mz(z,'image',['catchtap',2,'data-event-opts',1,'src',2,'style',3],[],e,s,gg)
_(lWBB,aXBB)
var tYBB=_mz(z,'view',['class',6,'style',1],[],e,s,gg)
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/customtitlebar/customtitlebar.wxss'] = setCssToHead([".",[1],"top{align-items:center;display:flex;flex-direction:row;margin-left:",[0,40],"}\n.",[1],"top .",[1],"title{flex:1;font-size:",[0,34],";font-weight:700;margin-right:",[0,100],";padding-left:",[0,10],";padding-right:",[0,10],";text-align:center;white-space:nowrap}\n",],undefined,{path:"./components/customtitlebar/customtitlebar.wxss"});
}